...
local textpl = viet.Text
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace[textpl].HumanoidRootPart.CFrame
end)
...
EspPlayer.BackgroundTransparency = 0.500
EspPlayer.BorderSizePixel = 0
EspPlayer.Position = UDim2.new(0.769999981, 0, 0.0270000007, 0)
EspPlayer.Size = UDim2.new(0, 52, 0, 28)
EspPlayer.Font = Enum.Font.Code
EspPlayer.Text = "EspPlayer"
EspPlayer.TextColor3 = Color3.fromRGB(255, 255, 255)
EspPlayer.TextScaled = true
EspPlayer.TextSize = 14.000
EspPlayer.TextWrapped = true
